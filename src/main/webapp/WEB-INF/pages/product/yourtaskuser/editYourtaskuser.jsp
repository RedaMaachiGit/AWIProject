...
<html>
<head>
<title>Edit <fmt:message key="product.title"/> <fmt:message key="yourtaskuser.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductYourtaskuser" method="POST" modelAttribute="yourtaskuser">
