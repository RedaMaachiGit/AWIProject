...
<html>
<head>
<title>View <fmt:message key="order.title"/> <fmt:message key="orderproduct.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteOrderOrderProducts?order_orderid=${order_orderid}&related_orderproducts_orderid=${orderproduct.orderid}&related_orderproducts_productid=${orderproduct.productid}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
