						...
						<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/indexGoal"><span><img src="images/icons/back.gif" /><fmt:message key="navigation.back"/></span></a></div>
							...
							<div class="col-sm-offset-3 col-sm-4 col-sm-offset-3">
								<span class="inputbutton">
									<div class="btn-lg btn-primary btn-block"><a class="button" href="${pageContext.request.contextPath}/deleteGoal?goalidKey=${goal.goalid}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
								</span>
								<!-- <div class="clear">&nbsp;</div> -->
							</div>
						</div>
