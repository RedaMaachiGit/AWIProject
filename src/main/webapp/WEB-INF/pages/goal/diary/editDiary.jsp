...
<html>
<head>
<title>Edit <fmt:message key="goal.title"/> <fmt:message key="diary.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveGoalDiary" method="POST" modelAttribute="diary">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="goal_goalid" value="${goal_goalid}" >
