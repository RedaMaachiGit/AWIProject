...
<html>
<head>
<title>Edit <fmt:message key="roleresource.title"/> <fmt:message key="resource.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRoleResourceResource" method="POST" modelAttribute="resource">
