...
<html>
<head>
<title>Edit <fmt:message key="roleresource.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRoleResource" method="POST" modelAttribute="roleresource">
