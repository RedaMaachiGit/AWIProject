			...
			<div class="col-md-7">
				...
				<!-- <div id="brc"><div id="tb"><div id="tlc"><div id="trc"> -->
					<div id="content">
						...
						<h1>My Products</h1>
						<div class="navitem">
							<a class="button" href="${pageContext.request.contextPath}/sc/${yourtaskuser.userid}/createProduct">
								...
								<c:forEach items="${yourtaskuser.products}" var="current"  varStatus="i">	
									...
									<tr class="${rowclass}">
										<td nowrap="nowrap">
											...
											<a title="<fmt:message key="navigation.edit" />" href="${pageContext.request.contextPath}/sc/${yourtaskuser.userid}/product/${current.productid}/editProduct">
												<span class="glyphicon glyphicon-pencil"></span>
											</a>
											
											<a title="<fmt:message key="navigation.delete" />" href="${pageContext.request.contextPath}/sc/${yourtaskuser.userid}/product/${current.productid}/deleteProduct">
