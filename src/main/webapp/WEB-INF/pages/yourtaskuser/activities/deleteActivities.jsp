	...
	<body>
		...
		<div class="container">
						...
						<div class="col-sm-offset-3 col-sm-4 col-sm-offset-3">
								<a class="btn btn-primary" href="${pageContext.request.contextPath}/deleteYourtaskuserActivities/${yourtaskuser_userid}/${activity.activityid}"><span class="glyphicon glyphicon-trash"></span> DELETE</a>
						</div>
						<div class="clear">&nbsp;</div>
					</div>
					<!-- </div></div></div></div> -->
