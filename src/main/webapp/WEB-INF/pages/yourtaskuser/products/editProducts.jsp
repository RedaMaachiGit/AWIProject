...
<html>
<head>
<title>Edit <fmt:message key="yourtaskuser.title"/> <fmt:message key="product.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveYourtaskuserProducts" method="POST" modelAttribute="product">
