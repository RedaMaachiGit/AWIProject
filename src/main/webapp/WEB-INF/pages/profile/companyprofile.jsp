		...
		<div class=row>
			<div class="col-sm-6">
				<div class="panel panel-success">
					...
					<div class="panel-body">
						<form:form
							action="${pageContext.request.contextPath}/sc/profile/save"
					...
					<div class="card-block">
						...
						&nbsp;
									...
									<div class="form-group">
										...
										<div class='input'>
											<input id="yourtaskuser_userdateofbirth"
												name="userdateofbirth" type="text"
												value="<fmt:formatDate value="${yourtaskuser.userdateofbirth.time}" pattern="yyyy-MM-dd"/>"
												dojoType="dijit.form.DateTextBox"
												constraints="{datePattern:'<fmt:message key="date.format"/>'}"
												trim="true"
												promptMessage="<fmt:message key="date.format" />"
												invalidMessage="<fmt:message key="date.format.invalid" /> <fmt:message key="date.format" />."
												style="width: 300px;" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class='input'>
											<form:input id="yourtaskuser_userusername"
												path="userusername" cssStyle="width:300px;" />
											<script type="text/javascript">
												Spring
														.addDecoration(new Spring.ElementDecoration(
																{
									...
									<div class="form-group">
										...
										<div class='input'>
											<form:input id="yourtaskuser_userpassword"
												path="userpassword" cssStyle="width:300px;" />
											<script type="text/javascript">
												Spring
														.addDecoration(new Spring.ElementDecoration(
			...
			<div class="col-sm-6">
				<div class="panel panel-success">
					...
					<div class="panel-body">
						<form:form
							action="${pageContext.request.contextPath}/sc/profile/saveYourtaskuserScinfos"
