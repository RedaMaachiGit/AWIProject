...
<html>
<head>
<title>Edit <fmt:message key="diary.title"/> <fmt:message key="yourtaskuser.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveDiaryYourtaskuser" method="POST" modelAttribute="yourtaskuser">
