					...
					<div id="content">
						<!-- Bouton back -->
							<div class="navitem">
								...
								<form:form action="${pageContext.request.contextPath}/saveDiaryDiaryentries/${userid}/${activityid}/${diaryid}" method="POST" modelAttribute="diaryentry">
									<table class="table table-list-search" id="viewTable">
										...
										<div class="col-sm-offset-3 col-sm-4 col-sm-offset-3">
											<span class="inputbutton">
												<input class="savebutton" id="save" type="submit" value="<fmt:message key="navigation.save"/>"/>
											</span>
										</div>
