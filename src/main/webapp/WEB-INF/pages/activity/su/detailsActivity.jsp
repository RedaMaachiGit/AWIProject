...
<body>
	<div class="container">
		<div class="row">
			<div class="navitem">
				<a class="button"
					href="${pageContext.request.contextPath}/su/activities"> <span
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					${activity.activitydescription}<br> Visibility :
					${activity.activityvisibility}<br>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="navitem">
				<a class="button"
					href="${pageContext.request.contextPath}/su/activity/${activity.activityid}/createDiary">
					<span class="glyphicon glyphicon-plus"></span> <span><fmt:message
							key="navigation.new" /> <fmt:message key="diary.title" /></span>
				</a>
			</div>
				...
				<tbody>
					<c:forEach items="${activity.diaries}" var="current" varStatus="i">
						...
						<tr class="${rowclass}">
							...
							</a> <a title="<fmt:message key="navigation.edit" />"
								href="${pageContext.request.contextPath}/su/activity/${activity.activityid}/diary/${current.iddiary}/editDiary">
									<span class="glyphicon glyphicon-pencil"></span>

							</a> <a title="<fmt:message key="navigation.delete" />"
								href="${pageContext.request.contextPath}/su/activity/${activity.activityid}/diary/${current.iddiary}/deleteDiary">
		...
		<div class="row">
			...
			<div class="navitem">
				<a class="button"
					href="${pageContext.request.contextPath}/su/activity/${activity.activityid}/createTask">
					<span class="glyphicon glyphicon-plus"></span> <span><fmt:message
							key="navigation.new" /> <fmt:message key="task.title" /></span>
				</a>
			</div>
			<table class="table table-list-search" id="viewTable">
				<thead>
					...
					<c:forEach items="${activity.tasks}" var="current" varStatus="i">
						...
						<tr class="${rowclass}">
							<td nowrap="nowrap"><a
								...
								href="${pageContext.request.contextPath}/su/activity/${activity.activityid}/task/${current.taskid}/editTask">
									<span class="glyphicon glyphicon-pencil"></span>
							</a> <a title="<fmt:message key="navigation.delete" />"
								href="${pageContext.request.contextPath}/su/activity/${activity.activityid}/task/${current.taskid}/deleteTask">
									<span class="glyphicon glyphicon-trash"></span>
							</a></td>
