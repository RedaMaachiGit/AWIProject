			...
			<tbody>
				...
				<tr class="${rowclass}">
					<td nowrap="nowrap" class="tabletd">
						<a title="<fmt:message key="navigation.view" />" href="${pageContext.request.contextPath}/selectPublicActivity?activityidKey=${current.activityid}&"><img src="images/icons/view.gif" /></a>
					</td>
					<td nowrap="nowrap" class="tabletd">
