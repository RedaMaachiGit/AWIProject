...
<html>
<head>
<title>Edit <fmt:message key="activity.title"/> <fmt:message key="yourtaskuser.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveActivityYourtaskuser" method="POST" modelAttribute="yourtaskuser">
