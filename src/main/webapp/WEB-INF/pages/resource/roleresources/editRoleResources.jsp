...
<html>
<head>
<title>Edit <fmt:message key="resource.title"/> <fmt:message key="roleresource.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveResourceRoleResources" method="POST" modelAttribute="roleresource">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="resource_resourceid" value="${resource_resourceid}" >
