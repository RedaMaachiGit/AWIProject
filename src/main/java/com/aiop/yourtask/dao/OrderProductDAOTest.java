...
public class OrderProductDAOTest {
	 ...
	 *
	 */
	private OrderProductDAO dataStore;

	/**
	 * Instantiates a new OrderProductDAOTest.
	 *
	 */
	...
	/**
	* Method to test OrderProduct domain object.
	*
	*/
	@Rollback(false)
	@Test
	...
	*/
	@Autowired
	public void setDataStore(OrderProductDAO dataStore) {
