...
public class DiaryentryDAOTest {
	 ...
	 *
	 */
	private DiaryentryDAO dataStore;

	/**
	 * Instantiates a new DiaryentryDAOTest.
	 *
	 */
	public DiaryentryDAOTest() {
	}

	/**
	* Method to test Diaryentry domain object.
	*
	*/
	@Rollback(false)
	@Test
	...
	*/
	@Autowired
	public void setDataStore(DiaryentryDAO dataStore) {
