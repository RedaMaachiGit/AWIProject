...
public class RoleResourceDAOTest {
	 ...
	 *
	 */
	private RoleResourceDAO dataStore;

	/**
	 * Instantiates a new RoleResourceDAOTest.
	 *
	 */
	public RoleResourceDAOTest() {
	}

	/**
	* Method to test RoleResource domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void RoleResource() {
		RoleResource instance = new RoleResource();
	...
	*/
	@Autowired
	public void setDataStore(RoleResourceDAO dataStore) {
