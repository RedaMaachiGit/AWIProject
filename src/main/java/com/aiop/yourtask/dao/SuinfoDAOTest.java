...
public class SuinfoDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private SuinfoDAO dataStore;

	/**
	 * Instantiates a new SuinfoDAOTest.
	 *
	 */
	public SuinfoDAOTest() {
	}

	/**
	* Method to test Suinfo domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void Suinfo() {
		Suinfo instance = new Suinfo();
	...
	*/
	@Autowired
	public void setDataStore(SuinfoDAO dataStore) {
