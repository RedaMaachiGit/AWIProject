...
public class ScinfoDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private ScinfoDAO dataStore;

	/**
	 * Instantiates a new ScinfoDAOTest.
	 *
	 */
	public ScinfoDAOTest() {
	}

	/**
	* Method to test Scinfo domain object.
	*
	*/
	@Rollback(false)
	@Test
	public void Scinfo() {
		Scinfo instance = new Scinfo();
	...
	*/
	@Autowired
	public void setDataStore(ScinfoDAO dataStore) {
